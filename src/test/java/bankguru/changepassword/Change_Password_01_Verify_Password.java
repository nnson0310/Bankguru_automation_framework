...
public class Change_Password_01_Verify_Password extends BaseTest {
    ...
    public void TC_01_Empty_Old_Password() {
        ...
        changePasswordPage.isValidationErrorMessageDisplayed(driver, oldPasswordFieldName, "Old Password must not be blank");
    }
    ...
    public void TC_02_Empty_New_Password() {
        ...
        changePasswordPage.isValidationErrorMessageDisplayed(driver, newPasswordFieldName, "New Password must not be blank");
    }
    ...
    public void TC_03_Must_Have_Numeric_Value() {
        ...
        changePasswordPage.isValidationErrorMessageDisplayed(driver, newPasswordFieldName, "Enter at-least one numeric value");
    }
    ...
    public void TC_04_Have_Password_String() {
        ...
        changePasswordPage.isValidationErrorMessageDisplayed(driver, newPasswordFieldName, "Choose a difficult Password");
    }
    ...
    public void TC_05_Confirm_Password_Unmatch() {
        ...
        changePasswordPage.isValidationErrorMessageDisplayed(driver, confirmPasswordFieldName, "Passwords do not Match");
    }
